...
//            dd(I('post.'));
            ...
            if($uid = M('user_member')->add($user)){
                ...
                $this->success('添加用户成功', U('Home/Rbac/index'));
            }else{
                $this->error('添加用户失败');
            }
        }
...
//            dd(I('post.'));
            ...
            if($uid = M('user_member')->where("id=%d",$u_id)->save($user)){
                ...
                $this->success('修改信息成功', U('Home/Rbac/index'));
            }else{
                $this->error('修改信息失败');
            }
        }
	...
	public function addRoleHandle(){
		...
		if($result){
			$this->success('添加角色成功', U('Home/Rbac/role'));
		}else{
			$this->error('添加失败');
		}
	}
	...
	public function addNodeHandle(){
		...
		if($result){
			$this->success('添加应用成功', U('Home/Rbac/node'));
		}else{
			$this->error('添加失败');
		}
	}
	...
	public function setAccess(){
		...
		if($result){
			$this->success('修改权限成功', U('Home/Rbac/role'));
		}else{
			$this->error('修改失败');
		}
	}
